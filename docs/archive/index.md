...
- [ADR 0025 - A refused registration is a fleet state, not a client error](../adr/0025-a-refused-registration-is-a-fleet-state.md) — `adr/0025-a-refused-registration-is-a-fleet-state.md`
