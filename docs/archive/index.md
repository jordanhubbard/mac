...
- [ADR 0001 — Unify the Hermes runtime into the `mac` monorepo](../adr/0001-unify-hermes-runtime-into-mac.md) — `adr/0001-unify-hermes-runtime-into-mac.md`
- [ADR 0002 — Memory store / vector tier at fleet scale (50–200 agents per hub)](../adr/0002-memory-store-at-scale.md) — `adr/0002-memory-store-at-scale.md`
- [ADR 0003 — Optional in-mac model router + vault (revisiting TokenHub's boundary)](../adr/0003-tokenhub-core-into-mac.md) — `adr/0003-tokenhub-core-into-mac.md`
- [ADR 0004 — One task database: revert the Hermes kanban adoption, keep our own board](../adr/0004-task-ledger-vs-hermes-kanban.md) — `adr/0004-task-ledger-vs-hermes-kanban.md`
- [ADR 0005 — Elastic executor tier vs. the static fleet (and "every agent is a GitHub runner")](../adr/0005-elastic-executor-tier-vs-static-fleet.md) — `adr/0005-elastic-executor-tier-vs-static-fleet.md`
- [ADR 0006 — Agent Client Protocol (ACP) support](../adr/0006-acp-support.md) — `adr/0006-acp-support.md`
- [ADR 0007 — Per-module ownership: mood_policy, nap_consolidator, soul_snapshot, memory_vetting](../adr/0007-hermes-boundary-mood-nap-soul-memory.md) — `adr/0007-hermes-boundary-mood-nap-soul-memory.md`
- [ADR 0008 - OpenShell uses Docker Engine/Moby as its only container runtime](../adr/0008-openshell-docker-engine-runtime.md) — `adr/0008-openshell-docker-engine-runtime.md`
- [ADR 0009 - Minimal sandbox base + on-demand, layered, cached provisioning](../adr/0009-minimal-base-on-demand-layered-provisioning.md) — `adr/0009-minimal-base-on-demand-layered-provisioning.md`
...
- [Assessment: task_83f38e9754f64908a316cccba0952329](../archive/field-notes/assessment-task-83f38e.md) — `archive/field-notes/assessment-task-83f38e.md`
- [Assessment: task_8bf37845abf445149d99fb4a1e3a41d5](../archive/field-notes/assessment-task-8bf378.md) — `archive/field-notes/assessment-task-8bf378.md`
