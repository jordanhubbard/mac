...
- [ADR 0025 - One liveness model for the deploy path; every hold names its owner](../adr/0025-one-liveness-model-for-deploy-holds.md) — `adr/0025-one-liveness-model-for-deploy-holds.md`
