...
| architecture decision | `adr/0025-terminal-evidence-makes-a-row-non-claimable.md` | ADR 0025 - Terminal evidence makes a row non-claimable, and retry needs lineage |
