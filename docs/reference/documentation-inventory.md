...
| architecture decision | `adr/0025-a-refused-registration-is-a-fleet-state.md` | ADR 0025 - A refused registration is a fleet state, not a client error |
...
| runbook | `refused-agent-registration-runbook.md` | Refused Agent Registration Runbook |
