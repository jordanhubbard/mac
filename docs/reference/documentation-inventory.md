...
| architecture decision | `adr/0028-the-route-search-path-is-a-fleet-contract.md` | ADR 0028: The coding-route search path is a fleet contract, not per-worker environment |
