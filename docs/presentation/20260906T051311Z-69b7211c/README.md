# MAC capabilities deck — `69b7211c`

Point-in-time capabilities deck for the v1.4.0 release, audited at commit
`69b7211c` and captured 2026-09-06T05:13:11Z.

## Deck

Slides: [MAC — v1.4.0 (`69b7211c`)](https://docs.google.com/presentation/d/1EeHFRp5xLqiTCnnL62icNlg4Kb031tOuwiUUxJoFMXU/edit?usp=drivesdk)
...
$ /tmp/deckvenv/bin/python docs/presentation/20260906T051311Z-69b7211c/build_deck.py
```
