# MAC capabilities deck — `e8040fec`

A point-in-time capabilities deck for MAC, built by auditing the source and documentation at
commit `e8040fec`, captured `2026-08-25T00:08:16Z`.

## The deck

**[MAC — What the control plane can do today (`e8040fec`)](https://docs.google.com/presentation/d/1cLzjGERKojHg0w1FOyUnlqlsVu_OZVM5b_kGc7T3fSw/edit)**
...
It describes `e8040fec` and nothing later, and is **not** updated as the code moves. Build a new
...
ADR 0017's seven days to 2026-08-19. The ledger census in `AUDIT.md` is from 2026-08-25.
...
4. **One control plane, four objects** — the CLI as the object model, 125 verbs, six surfaces
5. **A task is a state machine with receipts** — 12 states (STOPPED is new) and the four gates
...
10. **The fleet measures itself** — what it measures, the 2026-08-25 census, ADRs 0029 / 0017 / 0018
11. Scale at this commit
12. Proposed, deferred, or stale — stated up front
13. Provenance

Slide 12 is deliberate. Sixteen ADRs are still Proposed; ADR 0016 is Accepted as a decision while
the hub still drives review; ADR 0012 remains deferred; and the README still documents a vendored
runtime that is not in the tree (`AUDIT.md` §8). A capabilities deck that omits those is marketing.
...
$ cd docs/presentation/20260825T000816Z-e8040fec/images
...
$ /tmp/deckvenv/bin/python docs/presentation/20260825T000816Z-e8040fec/build_deck.py
```
