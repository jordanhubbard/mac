...
TOOLS: tuple[ToolSpec, ...] = (
    ToolSpec(
        ...
        description=(
            ...
            "the target project is known and set `required_capabilities` to the "
            "kind of executor needed. For MAC control-plane/API/UI/runner/plugin "
            "work use `project: mac`. For UI/layout/readability/frontend work use "
            "`required_capabilities: ['frontend','design']`; for backend/API/task "
            "ledger work use `['python']`; for Kubernetes/deploy/infra work use "
            "`['ops']`. If you cannot determine project/capabilities, ask a "
