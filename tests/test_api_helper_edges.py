...
def test_payload_bounds_are_enforced() -> None:
    # `_clamp_int` was asserted here too. It clamped the terminal-session
    # rows/cols/ttl arguments and had no other caller, so it went with the PTY
    # facade rather than staying as tested dead code.
