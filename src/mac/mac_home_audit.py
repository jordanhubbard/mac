...
# Pre-Phase-2 on-disk shape: these names live directly at the control-plane
# home today. Each maps to its §4 canonical target.
LEGACY_ROOT_TARGETS: Mapping[str, str] = {
    ...
    # Recognised current home-root owners not yet drawn in the §4 tree graphic.
...
def audit_mac_home(root: Pathish = None, *, home: Pathish = None) -> Dict[str, Any]:
    """Read-only audit of ``mac_paths.mac_home()``.
