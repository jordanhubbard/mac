...
LOCAL_GEN_MODELS: Tuple[LocalGenModel, ...] = (
    ...
    LocalGenModel("musicgen-small", "audio", "audio.music", "facebook/musicgen-small",
                  3000, ("cuda", "metal"), "transformers", "audio_music", True,
                  "MusicGen small — text-to-music (binary audio via /audio/music)"),
    LocalGenModel("bark", "audio", "audio.tts", "suno/bark",
                  4000, ("cuda", "metal"), "transformers", "openai_audio_speech", True,
                  "Bark — text-to-speech (binary audio via /audio/speech)"),
    LocalGenModel("whisper-large-v3", "audio", "audio.asr", "openai/whisper-large-v3",
                  10000, ("cuda",), "transformers", "openai_audio_transcription", True,
                  "Whisper large v3 — speech-to-text (multipart upload -> text)"),
