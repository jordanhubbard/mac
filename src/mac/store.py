...
class Store(Protocol):
    ...
    def record_fleet_release_admission_episode(self, *args: Any, **kwargs: Any) -> None: ...
    def get_fleet_release_admission_episode(self, *args: Any, **kwargs: Any) -> Optional[Any]: ...
    def list_fleet_release_admission_episodes(self, *args: Any, **kwargs: Any) -> list: ...
